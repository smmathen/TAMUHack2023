...
const MONGODB_URI =
  "mongodb+srv://kaster-admin:dutyland@kaster.gbdbqkw.mongodb.net/kaster_users?retryWrites=true&w=majority";
...
async function connectToDatabase() {
  ...
  const db = await client.db("kaster_users");
...
exports.handler = async (event, context) => {
  ...
  const user_a = await db.collection("user_a").find({}).limit(20).toArray();
